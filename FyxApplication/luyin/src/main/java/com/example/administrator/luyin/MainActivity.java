package com.example.administrator.luyin;
...
//                stopLuyin();
    ...
    private void getQuanxian() {
        ...
        if (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)  + ContextCompat.checkSelfPermission(MainActivity.this,  Manifest.permission.RECORD_AUDIO)
