...
import com.fyx.adapter.OrientedAutoViewPager;
import com.fyx.adapter.transform.HorizontalStackTransformer;
...
public class ScrViewPagerActivity extends AppCompatActivity {
    ...
    private void initPageData(final List<Fragment> cardFragments) {
        //第一步，叠图计算,获取循环数据
        List<Fragment> frgs = ScreenUtils.getLoopData(cardFragments);
