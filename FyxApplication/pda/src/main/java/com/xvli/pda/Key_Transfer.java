...
public class Key_Transfer extends BaseActivity implements View.OnClickListener {
    ...
    List<KeyPasswordVo> keyPasswordVoList1 = new ArrayList<KeyPasswordVo>();
    ; //确认交接钥匙集合
...
//        editText_receive  = (EditText)findViewById(R.id.add_key_receive);
    ...
    public void keyScantransfer(String scanResult) {
        ...
        if (Regex.isChaoKey(scanResult)) {
            ...
            if (list != null && list.size() > 0) {
                CustomToast.getInstance().showLongToast(getResources().getString(R.string.dontrece));
            } else {
                ...
                if (dynNodeItemVos!=null &&dynNodeItemVos.size()>0) {
                    ...
                    if (branchVoList != null && branchVoList.size() > 0) {
                        ...
                        keyPaw.put("itemtype", KeyPasswordVo.KEY);
                        ...
                        if (keyPasswordVoList != null && keyPasswordVoList.size() > 0) {
                            CustomToast.getInstance().showShortToast(getResources().getString(R.string.key_scan));
                        } else {
    ...
    public void onClick(View v) {
        if (v == btn_back) {
            ...
            in.putExtra("code","");
            Key_Transfer.this.setResult(resultCode,in);
            finish();
        } else if (v == bt_updata_key_transfer) {
            if (keyPasswordVoList1 != null && keyPasswordVoList1.size() > 0) {
                showSureUpDataDialog();
            } else {
                CustomToast.getInstance().showShortToast(getResources().getString(R.string.chenk_key_transfer));
            }
    ...
    private void showDeleteDialog(final int position) {
        ...
        bt_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                key_transfer_list.setAdapter(new MyKeyTransferAdpater(Key_Transfer.this, key_scan_transfer_list));
                dialog.dismiss();
            }
        });
