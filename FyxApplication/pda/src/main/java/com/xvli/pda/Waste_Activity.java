 ...
 * 废钞
 */
public class Waste_Activity extends  BaseActivity implements OnClickListener
{
    ...
    public void initeview()
    {
        ...
        tv_title.setText(getResources().getString(R.string.add_waste_title));
        ...
        tv_add.setText(getResources().getString(R.string.add_waste_add_tv));
...
//            showDialog();
        ...
        else if(arg0==bt_save)
        {
            if(!TextUtils.isEmpty(edt_code.getText())/*&&!TextUtils.isEmpty(edt_mony.getText())*/&&!TextUtils.isEmpty(edt_time.getText())) {
                if (isexist(edt_code.getText().toString())) {//删除的还可以再添加
    ...
    private void setDataToDb(MyAtmError error, int witch) {
        ...
        if(!TextUtils.isEmpty(edt_mony.getText())){
     ...
     * 手动输入废钞提示框
     */
    private void showWasteAutoDialog() {
		// TODO Auto-generated method stub
        ...
        tv_tip.setHint(getResources().getString(R.string.input_waste_paper));
                ...
                if (cardInput == null || "".equals(cardInput)) {
                    ...
                    if (length == 1) {
                        if (cardInput.equals(secondConfirm)) {
                                showDialog();
                                edt_code.setText("000004000" + cardInput);
                        } else {
                        ...
                        if (cardInput.equals(secondConfirm)) {
                                showDialog();
                                edt_code.setText("00000400" + cardInput);
                        } else {
                            CustomToast.getInstance().showLongToast(getResources().getString(R.string.input_error_tip));
                        }
                    } else if (length == 3) {
                        if (cardInput.equals(secondConfirm)) {
                                showDialog();
                                edt_code.setText("0000040" + cardInput);
                        } else {
                            CustomToast.getInstance().showLongToast(getResources().getString(R.string.input_error_tip));
                        }
                    } else if (length == 4) {
                        if (cardInput.equals(secondConfirm)) {
                                showDialog();
                                edt_code.setText("000004" + cardInput);
                        } else {
                            CustomToast.getInstance().showLongToast(getResources().getString(R.string.input_error_tip));
                        }
                    }
