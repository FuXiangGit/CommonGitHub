...
public class EidtPhoto_Activity extends BaseActivity implements OnClickListener {
...
//			photoVo.setTaskid(Long.parseLong(tmrDyn_bean.getTaskid()));
//			photoVo.setAtmid(Long.parseLong(tmrDyn_bean.getAtmid()));
