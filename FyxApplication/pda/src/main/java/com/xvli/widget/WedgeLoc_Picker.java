...
public class WedgeLoc_Picker extends LinearLayout
{
    /** 滑动控件 */
    ...
    public WedgeLoc_Picker(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public WedgeLoc_Picker(Context context) {
            super(context);
            this.context = context;
            getdefultInfo();
            // TODO Auto-generated constructor stub
    ...
    public void getdefultInfo()
    {
        ...
        String[] loc=getResources().getStringArray(R.array.wedge);
