 ...
 * 2016-03-04
 */
@DatabaseTable(tableName = "NET_WORK_ROUT")
public class NetWorkRouteVo implements Serializable{

	private static final long serialVersionUID = 1L;

	public NetWorkRouteVo() {
	}
