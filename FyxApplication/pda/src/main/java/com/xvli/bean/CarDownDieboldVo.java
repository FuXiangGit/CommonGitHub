...
/**
 * Created by Administrator on 10:50.
 */

//迪堡下车表
@DatabaseTable  (tableName="T_CarDownDieboldVo")
public class CarDownDieboldVo implements Serializable {

    public CarDownDieboldVo() {
    }

    @DatabaseField(generatedId = true)
    private int id;

    //物品类型，钞箱("0")，钞袋("1")，卡钞("2")，废钞("3") ，如果是计划之外的物品也不在基础数据中则为-1
    @DatabaseField
