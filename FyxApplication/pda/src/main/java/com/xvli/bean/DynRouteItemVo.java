 ...
 * 2016-03-04
 */
@DatabaseTable(tableName = "TMR_ROUTITEM_VO")
public class DynRouteItemVo implements Serializable{

	private static final long serialVersionUID = 1L;

	public DynRouteItemVo() {
	}
...
//			"isroutetask": true}
	...
	public DynRouteItemVo(String atmcustomerid, int atminstallationmethod, String atmnodetype, String atmtype, String clientid, String code, boolean enabled, String id, int ids, int inputtype, boolean isatmornode, String isCanUp, String isDone, boolean isoperatetask, boolean isphoto, boolean isrepairtask, boolean isroutetask, String isUploaded, String name, String operatedtime, String operator, int order, String selectitems) {
		...
		this.isDone = isDone;
		this.isoperatetask = isoperatetask;
		this.isphoto = isphoto;
		this.isrepairtask = isrepairtask;
		this.isroutetask = isroutetask;
	...
	public boolean isoperatetask() {
		return isoperatetask;
	}

	public void setIsoperatetask(boolean isoperatetask) {
		this.isoperatetask = isoperatetask;
	}
	...
	public void setIsrepairtask(boolean isrepairtask) {
		this.isrepairtask = isrepairtask;
	}
	...
	public void setIsroutetask(boolean isroutetask) {
		this.isroutetask = isroutetask;
	}
