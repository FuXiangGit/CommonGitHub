...
//    private Dao<LoginVo,Integer> dao = null;
    ...
    public TruckDao(DatabaseHelper mHelper) {
        this.run_dao = mHelper.getRuntimeExceptionDao(TruckVo.class);
    }
    ...
    public List<TruckVo> quaryForDetail(Map<String, Object> mDbWhere) {
        List<TruckVo> list = run_dao.queryForFieldValues(mDbWhere);
    ...
    public int contentsNumber(TruckVo beanVo) {
        ...
        List<TruckVo> lists = run_dao.queryForFieldValues(where);
