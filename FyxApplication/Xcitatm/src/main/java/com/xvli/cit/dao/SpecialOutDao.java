...
//    private Dao<LoginVo,Integer> dao = null;
    ...
    public SpecialOutDao(DatabaseHelper mHelper) {
        this.run_dao = mHelper.getRuntimeExceptionDao(SpecialOutVo.class);
    }
     ...
     * @return
     */
    public int create(SpecialOutVo bean) {
     ...
     * @param bean
     */
    public void upDate(SpecialOutVo bean) {
        run_dao.update(bean);
    }
     ...
     * @return
     */
    public List<SpecialOutVo> queryAll() {
        List<SpecialOutVo> lists = null;
     ...
     * @return
     */
    public List<SpecialOutVo> quaryForDetail(Map<String, Object> mDbWhere) {
        List<SpecialOutVo> list = run_dao.queryForFieldValues(mDbWhere);
